...
const stickersData = [
  ...
  // Grupo B
  { page: 16, code: 'CAN', name: 'Canada', group: 'B' },
  { page: 18, code: 'BIH', name: 'Bosnia & Herzegovina', group: 'B' },
  { page: 20, code: 'QAT', name: 'Qatar', group: 'B' },
  { page: 22, code: 'SUI', name: 'Switzerland', group: 'B' },
  // Grupo C
  ...
  // Grupo D
  { page: 32, code: 'USA', name: 'USA', group: 'D' },
  { page: 34, code: 'PAR', name: 'Paraguay', group: 'D' },
  { page: 36, code: 'AUS', name: 'Australia', group: 'D' },
  { page: 38, code: 'TUR', name: 'Turkey', group: 'D' },
  // Grupo E
  ...
  // Grupo F
  { page: 48, code: 'NED', name: 'Netherlands', group: 'F' },
  { page: 50, code: 'JPN', name: 'Japan', group: 'F' },
  { page: 52, code: 'SWE', name: 'Sweden', group: 'F' },
  { page: 54, code: 'TUN', name: 'Tunisia', group: 'F' },
  // Grupo G
  ...
  // Grupo H
  { page: 66, code: 'ESP', name: 'Spain', group: 'H' },
  { page: 68, code: 'CPV', name: 'Cape Verde', group: 'H' },
  { page: 70, code: 'KSA', name: 'Saudi Arabia', group: 'H' },
  { page: 72, code: 'URU', name: 'Uruguay', group: 'H' },
  // Grupo I
  ...
  // Grupo J
  { page: 82, code: 'ARG', name: 'Argentina', group: 'J' },
  { page: 84, code: 'ALG', name: 'Algeria', group: 'J' },
  { page: 86, code: 'AUT', name: 'Austria', group: 'J' },
  { page: 88, code: 'JOR', name: 'Jordan', group: 'J' },
  // Grupo K
  ...
  // Grupo L
  { page: 98, code: 'ENG', name: 'England', group: 'L' },
  { page: 100, code: 'CRO', name: 'Croatia', group: 'L' },
  { page: 102, code: 'GHA', name: 'Ghana', group: 'L' },
  { page: 104, code: 'PAN', name: 'Panama', group: 'L' },
]
