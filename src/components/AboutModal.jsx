        ...
        <div className="about-content">
          ...
          <div className="about-opensource">
            ...
            <div className="about-opensource-actions">
              <a href="https://github.com/studio84dev/mi-album-fifa" target="_blank" rel="noopener noreferrer" className="about-opensource-btn about-opensource-btn--star">
              ...
              <a href="https://github.com/studio84dev/mi-album-fifa/issues" target="_blank" rel="noopener noreferrer" className="about-opensource-btn">
              ...
              <a href="https://github.com/studio84dev/mi-album-fifa/blob/master/CONTRIBUTING.md" target="_blank" rel="noopener noreferrer" className="about-opensource-btn">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" width="14" height="14"><path d="M16 18l6-6-6-6"/><path d="M8 6l-6 6 6 6"/></svg>
